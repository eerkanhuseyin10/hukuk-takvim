...
const AYDINLATMA_METNI_SURUMU='3.0';
function kvkkAydinlatmaHTML(){return `<div style="font-size:12px;line-height:1.65;color:var(--text2);"><h3 style="color:var(--text);margin-top:0;">1. Veri sorumlusu</h3><p>Sekreter kullanıcı hesabı, platform güvenliği ve hizmetin işletilmesine ilişkin kişisel veriler bakımından veri sorumlusu <b>Ad Soyad</b>'dır.</p><p>İletişim ve KVKK başvuru e-postası: <b>E-posta Adresi</b><br>Adres: <b>Adres</b></p><p>Her hukuk bürosu; kendi kullanıcılarının sisteme girdiği müvekkil, dava dosyası, evrak, mesleki işlem ve mali içerikler bakımından işleme amaçlarını ve araçlarını belirlediği ölçüde ayrıca veri sorumlusudur. Sekreter hizmet sağlayıcısı bu içerikler bakımından ilgili büronun talimatlarıyla teknik hizmet sunar.</p><h3 style="color:var(--text);">2. İşlenen veri kategorileri</h3><ul><li>Kimlik ve iletişim: ad, soyad, e-posta adresi.</li><li>Hesap ve büro: kullanıcı kimliği, büro üyeliği, rol ve yetkiler.</li><li>İşlem güvenliği: oturum, kayıt işlemleri, davet, mali alan erişimi, yedekleme ve sistem hata kayıtları.</li><li>Büro tarafından girilen içerikler: müvekkil ve karşı taraf bilgileri, dava/dosya bilgileri, takvim, evrak açıklamaları, işlem geçmişi ve mali kayıtlar.</li><li>Teknik bağlantı verileri: hizmet sağlayıcı altyapısınca işlenebilen IP, cihaz, tarayıcı ve bağlantı zamanı bilgileri.</li></ul><h3 style="color:var(--text);">3. İşleme amaçları ve hukuki sebepler</h3><p>Hesabın oluşturulması, e-posta adresinin doğrulanması, büro içi yetkilendirme, ortak takvim hizmetinin sunulması, veri güvenliğinin sağlanması, kötüye kullanımın önlenmesi, dışa aktarma/yedek olanağı, uyuşmazlıkların çözümü ve kanuni yükümlülüklerin yerine getirilmesi amaçlarıyla veri işlenir. İşleme; sözleşmenin kurulması veya ifası, veri sorumlusunun hukuki yükümlülüğü, bir hakkın tesisi/kullanılması/korunması ve ilgili kişinin temel haklarına zarar vermemek kaydıyla meşru menfaat hukuki sebeplerine dayanır.</p><p>Müvekkil ve dava dosyası içeriklerinin, özellikle özel nitelikli kişisel verilerin işlenme şartını belirleme ve gerekli aydınlatmayı yapma sorumluluğu içeriği sisteme giren hukuk bürosuna aittir.</p><h3 style="color:var(--text);">4. Toplama yöntemi</h3><p>Veriler; web veya masaüstü uygulamasındaki formlar, e-posta doğrulaması, kullanıcı işlemleri, büro davetleri, yüklenen kayıtlar ve hizmet altyapısının otomatik güvenlik kayıtları aracılığıyla elektronik ortamda elde edilir.</p><h3 style="color:var(--text);">5. Alıcılar ve yurt dışı aktarımı</h3><p>Veriler; aynı bürodaki rolüne göre yetkili kullanıcılarla, hizmetin barındırılması, veritabanı, dosya saklama ve kimlik doğrulama hizmetlerini sağlayan Supabase altyapısıyla ve hukuken zorunlu hâllerde yetkili kamu kurumlarıyla amaçla sınırlı olarak paylaşılabilir.</p><p>Sekreter'in üretim verileri <b>Supabase Central EU (Frankfurt), Almanya</b> bölgesinde barındırılır. Bu kullanım Türkiye dışına kişisel veri aktarımı niteliğindedir. Aktarımın KVKK'nın 9. maddesinde öngörülen uygun güvence ve aktarım mekanizmaları kapsamında yürütülmesi amaçlanır. Altyapı sağlayıcısının teknik destek, güvenlik ve alt hizmet sağlayıcı süreçleri kendi sözleşme ve veri işleme koşullarına tabidir.</p><h3 style="color:var(--text);">6. Saklama ve silme süreleri</h3><ul><li>Hesap, büro ve mesleki içerikler: hesap veya büro ilişkisi sürdükçe; kullanıcı ya da yetkili yönetici silme işlemini gerçekleştirdiğinde aktif sistemden kaldırılır.</li><li>İşlem ve güvenlik günlükleri: güvenlik ve uyuşmazlıkların çözümü amacıyla en fazla <b>2 yıl</b>.</li><li>Kullanılmış, iptal edilmiş veya süresi dolmuş davet kayıtları: olay tarihinden itibaren en fazla <b>30 gün</b>.</li><li>Çözümlenmiş geliştirme/destek bildirimleri: çözüm tarihinden itibaren en fazla <b>2 yıl</b>.</li><li>Aydınlatma ve kullanım koşulu kayıtları: hesap devam ettiği sürece; hesap silindiğinde hesapla birlikte kaldırılır.</li><li>Kullanıcının indirdiği dışa aktarma ve yedek dosyaları: kullanıcının kontrolündedir; ihtiyaç sona erdiğinde güvenli biçimde silinmelidir.</li></ul><p>Ücretsiz altyapı planında sağlayıcı tarafından indirilebilir otomatik veritabanı yedeği sunulmadığından, yetkili büro kullanıcısının uygulamadaki dışa aktarma araçlarıyla düzenli yedek alması önerilir.</p><h3 style="color:var(--text);">7. İlgili kişinin hakları</h3><p>KVKK'nın 11. maddesi kapsamında kişisel verilerinizin işlenip işlenmediğini öğrenme, bilgi isteme, işleme amacını ve amaca uygun kullanılıp kullanılmadığını öğrenme, aktarılan kişileri bilme, eksik veya yanlış verilerin düzeltilmesini isteme, şartları oluştuğunda silme/yok etme isteme, düzeltme ve silmenin aktarılan kişilere bildirilmesini isteme, otomatik analiz sonucuna itiraz etme ve hukuka aykırı işleme nedeniyle zararın giderilmesini isteme haklarına sahipsiniz.</p><h3 style="color:var(--text);">8. Başvuru</h3><p>Başvurularınızı kimliğinizi doğrulamaya elverişli bilgiler ve talebinizle birlikte <b>E-posta Adresi</b> üzerinden veya yukarıdaki <b>Adres</b> bilgisine iletebilirsiniz.</p><div style="border:1px solid #f5d28b;background:#fffbeb;border-radius:10px;padding:11px;margin-top:14px;"><b>Önemli:</b> Bu platform aydınlatması, hukuk bürolarının kendi müvekkillerine ve diğer ilgili kişilere karşı yerine getirmesi gereken faaliyet bazlı aydınlatmanın yerine geçmez.</div></div>`;}
...
function sekreterHakkindaPenceresi(){let o=document.getElementById('hakkinda-overlay');if(!o){o=document.createElement('div');o.id='hakkinda-overlay';o.className='modal-overlay';o.style.zIndex='660';document.body.appendChild(o);}o.innerHTML=`<div class="modal" style="max-width:720px;"><div class="modal-header"><div><h2>Sekreter Hakkında</h2><div style="font-size:11px;color:var(--text2);margin-top:3px;">Hukuk büroları için takvim ve büro yönetimi · v${UYGULAMA_SURUMU}</div></div><button class="btn" onclick="document.getElementById('hakkinda-overlay').style.display='none'">✕</button></div><div class="modal-body" style="max-height:75vh;overflow:auto;"><p style="font-size:13px;line-height:1.65;color:var(--text2);">Sekreter; hukuk bürolarının takvim, süreli iş, duruşma, müvekkil, dava dosyası ve mali takip süreçlerini ekipçe tek yerde yönetmesine yardımcı olan bir çalışma uygulamasıdır.</p><div style="display:grid;gap:8px;margin:14px 0;">${['Ortak büro takvimi ve iş takibi','Müvekkil ve dava dosyası kartları','UYAP .ics duruşma aktarımı','Büro rolleri, bildirimler ve işlem günlüğü','Dosya, tahsilat, masraf ve ortaklık takibi'].map(x=>`<div style="padding:10px 12px;background:var(--surface2);border-radius:9px;font-size:12px;">✓ ${x}</div>`).join('')}</div><div style="font-size:11px;color:var(--text3);border-top:1px solid var(--border);padding-top:12px;">Sürüm ${UYGULAMA_SURUMU} · Telif © Hüseyin Erkan</div></div></div>`;o.style.display='flex';o.onclick=e=>{if(e.target===o)o.style.display='none';};}
function nasilKullanilirPenceresi(){let o=document.getElementById('nasil-kullanilir-overlay');if(!o){o=document.createElement('div');o.id='nasil-kullanilir-overlay';o.className='modal-overlay';o.style.zIndex='665';document.body.appendChild(o);}const adim=(n,b,m)=>`<div style="display:grid;grid-template-columns:30px 1fr;gap:10px;align-items:start;padding:11px 0;border-bottom:1px solid var(--border);"><b style="width:28px;height:28px;border-radius:50%;background:var(--navy);color:white;display:flex;align-items:center;justify-content:center;">${n}</b><div><strong>${b}</strong><div style="font-size:11px;color:var(--text2);line-height:1.55;margin-top:3px;">${m}</div></div></div>`;o.innerHTML=`<div class="modal" style="max-width:620px;"><div class="modal-header"><div><h2>Nasıl Kullanılır?</h2><div style="font-size:11px;color:var(--text2);">Sekreter'e hızlı başlangıç</div></div><button class="btn" onclick="document.getElementById('nasil-kullanilir-overlay').style.display='none'">✕</button></div><div class="modal-body">${adim(1,'Büronu oluştur veya davetle katıl','Yönetici yeni büro kurabilir; diğer kullanıcılar tek kullanımlık davet koduyla aynı büroya katılabilir.')}${adim(2,'Takvim kaydı ekle','Alt menüdeki Ekle düğmesinden duruşma, süreli iş, genel iş veya tekrarlayan kayıt oluşturabilirsin.')}${adim(3,'Müvekkil ve dosyaları bağla','Kayıtları müvekkil ve dava dosyalarıyla ilişkilendirerek bütün geçmişi Büro Kartları bölümünden izleyebilirsin.')}${adim(4,'UYAP duruşmalarını aktar','Yetkili kullanıcılar İçe ve Dışa Aktar bölümünden UYAP .ics dosyasını önizleyip seçtikleri dosyaları takvime ekleyebilir.')}${adim(5,'Bildirimleri ve mali takibi kullan','Büro bildirimlerini ayarlayabilir; yetkin varsa dosya, tahsilat, masraf ve ortaklık hareketlerini Mali Takip bölümünde yönetebilirsin.')}<div style="padding:11px;background:#fff8e8;border-radius:10px;font-size:11px;line-height:1.55;margin-top:12px;">Takvim ve süre hesaplarını resmî kaynaklardan kontrol etmeyi, düzenli dışa aktarma almayı unutma.</div></div></div>`;o.style.display='flex';o.onclick=e=>{if(e.target===o)o.style.display='none';};}
async function openGuncellemeler(){const[{data:ayar},{data:duyurular}]=await Promise.all([sb.from('platform_ayarlari').select('*').eq('id',true).maybeSingle(),sb.from('platform_duyurular').select('*').eq('aktif',true).order('created_at',{ascending:false}).limit(10)]);let o=document.getElementById('guncellemeler-overlay');if(!o){o=document.createElement('div');o.id='guncellemeler-overlay';o.className='modal-overlay';o.style.zIndex='668';document.body.appendChild(o);}const liste=(duyurular||[]).map(d=>`<div class="platform-notice-card"><b>${esc(d.baslik)}</b><div>${esc(d.mesaj)}</div><small style="display:block;margin-top:6px;color:var(--text3);">${formatDate((d.created_at||'').split('T')[0])}</small></div>`).join('')||'<div class="ly-empty">Şu anda yayımlanmış yeni bir duyuru yok.</div>';o.innerHTML=`<div class="modal" style="max-width:600px;"><div class="modal-header"><div><h2>Güncellemeler</h2><div style="font-size:11px;color:var(--text2);">Yüklü sürüm v${UYGULAMA_SURUMU}${ayar?.guncel_surum?' · Güncel sürüm v'+esc(ayar.guncel_surum):''}</div></div><button class="btn" onclick="document.getElementById('guncellemeler-overlay').style.display='none'">✕</button></div><div class="modal-body">${liste}${window.sekreterDesktop?'<button class="btn" style="width:100%;margin-top:10px;" onclick="guncellemeDenetle()">↻ Güncellemeyi Denetle</button>':''}</div></div>`;o.style.display='flex';o.onclick=e=>{if(e.target===o)o.style.display='none';};}
...
function ayarButonu(etiket,islem){return `<button class="btn" style="width:100%;text-align:left;padding:11px 13px;" onclick="ayarAltSayfaAc(()=>{${islem}})">${etiket}</button>`;}
...
function openAyarlarMerkezi(){
  ...
  const guvenlik=[yonetici?ayarButonu('🕘 İşlem ve Erişim Günlüğü','openIslemGunlugu()'):'',veriYetkili?ayarButonu('↕ İçe ve Dışa Aktar','openDisaAktar()'):'',ayarButonu('🔔 Bildirim Ayarları','openBildirimAyarlari()'),ayarButonu('⚖️ Yasal Metinler','yasalMetinlerPenceresi()')].join('');
  const uygulama=[ayarButonu('📋 Liste Yönetimi','openListeYonetim()'),masaustu?ayarButonu('↻ Güncellemeyi Denetle','guncellemeDenetle()'):'',ayarButonu('💡 Destek Talebi','openNotlar()')].join('');
...
async function openEDurusmaAyari(){
  ...
  const{data,error}=await sb.from('buro_ayarlari').select('e_durusma_otomatik,e_durusma_muaf_yerler').eq('buro_id',_buro.id).maybeSingle();
  if(error){alert('E-Duruşma ayarı okunamadı: '+error.message);return;}
  let o=document.getElementById('e-durusma-ayari-overlay');if(!o){o=document.createElement('div');o.id='e-durusma-ayari-overlay';o.className='modal-overlay';o.style.zIndex='650';document.body.appendChild(o);}
  o.innerHTML=`<div class="modal" style="max-width:540px;"><div class="modal-header"><div><h2>Otomatik E-Duruşma Talebi</h2><div style="font-size:11px;color:var(--text2);margin-top:3px;">Büroya özel konum ve hatırlatma ayarı</div></div><button class="btn" onclick="document.getElementById('e-durusma-ayari-overlay').style.display='none'">✕</button></div><div class="modal-body"><label style="display:flex;gap:9px;align-items:flex-start;margin-bottom:14px;"><input id="e-durusma-otomatik" type="checkbox" style="margin-top:2px;" ${data?.e_durusma_otomatik?'checked':''}><span><b>Otomatik talep işi oluştur</b><br><span style="font-size:11px;color:var(--text2);">Uygun duruşmadan 24 saat önce “E-Duruşma Talebi” adlı süreli iş oluşturulur.</span></span></label><div class="fg"><label>Büronun bulunduğu / istisna tutulacak yerler</label><input id="e-durusma-yerler" value="${esc((data?.e_durusma_muaf_yerler||[]).join(', '))}" placeholder="Örn. Balıkesir, Savaştepe, İzmir"><div style="font-size:10px;color:var(--text3);margin-top:5px;line-height:1.5;">Şehir ve ilçeleri virgülle ayırın. Mahkeme adında bu yerlerden biri geçiyorsa e-duruşma talebi oluşturulmaz.</div></div><div style="padding:11px;border-radius:10px;background:var(--surface2);font-size:11px;color:var(--text2);line-height:1.55;margin:12px 0;">Ceza, CMK, tevkil, keşif, randevu, arabuluculuk ve tahkim kayıtlarında otomatik talep oluşturulmaz. Oluşan işi göndermeden önce kontrol etme sorumluluğu kullanıcıdadır.</div><button class="save-btn" onclick="eDurusmaAyariKaydet()">Ayarı Kaydet</button></div></div>`;
  o.style.display='flex';o.onclick=e=>{if(e.target===o)o.style.display='none';};
}
async function eDurusmaAyariKaydet(){
  const otomatik=document.getElementById('e-durusma-otomatik').checked;
  const yerler=(document.getElementById('e-durusma-yerler').value||'').split(',').map(x=>x.trim()).filter(Boolean);
  if(otomatik&&!yerler.length){alert('Otomatik özelliği açmak için en az bir şehir veya ilçe yazın.');return;}
  const{error}=await sb.from('buro_ayarlari').upsert({buro_id:_buro.id,e_durusma_otomatik:otomatik,e_durusma_muaf_yerler:yerler,updated_at:new Date().toISOString(),updated_by:_user.id},{onConflict:'buro_id'});
  if(error){alert('Kaydedilemedi: '+error.message);return;}
  document.getElementById('e-durusma-ayari-overlay').style.display='none';alert('✓ E-Duruşma ayarı kaydedildi.');
}
...
function authEkrani(ekran){
  ...
  document.getElementById('auth-onay-form').style.display='none';
  ...
  if(ekran==='giris') document.getElementById('auth-giris-form').style.display='block';
    ...
    document.getElementById('auth-onay-form').style.display='block';
    let bekleyen='';try{bekleyen=localStorage.getItem('sekreter_bekleyen_onay_email')||'';}catch(e){}
    if(bekleyen)document.getElementById('auth-onay-email').value=bekleyen;
  }
}
let _koMod='yeni';
...
async function kayitOl(){
  ...
  if(data.session){
    ...
    try{localStorage.setItem('sekreter_bekleyen_onay_email',email);}catch(e){}
    authEkrani('onay');
    document.getElementById('auth-onay-email').value=email;
    setAuthMsg('✓ Doğrulama kodu e-posta adresinize gönderildi.','#4ade80');
  }
}

async function emailKayitKodunuDogrula(){
  const email=(document.getElementById('auth-onay-email').value||'').trim();
  const token=(document.getElementById('auth-onay-kod').value||'').replace(/\s/g,'');
  if(!email||!token){setAuthMsg('E-posta adresi ve doğrulama kodu zorunludur.','#f87171');return;}
  setAuthMsg('E-posta doğrulanıyor...','rgba(255,255,255,0.5)');
  const{data,error}=await sb.auth.verifyOtp({email,token,type:'signup'});
  if(error){setAuthMsg('Kod doğrulanamadı: '+error.message,'#f87171');return;}
  try{localStorage.removeItem('sekreter_bekleyen_onay_email');}catch(e){}
  _user=data.user;
  setAuthMsg('✓ E-posta doğrulandı. Büro hazırlanıyor...','#4ade80');
  await authSonrasiIslem();
}

async function emailKayitKodunuYenidenGonder(){
  const email=(document.getElementById('auth-onay-email').value||'').trim();
